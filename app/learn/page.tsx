...
export default function Learn(){
  ...
  return <main className="shell page"><Link href="/plants">← Plant Catalog</Link>
    ...
    <section className="stats"><article><strong>{mcq.attempts}</strong><span>MCQ attempts</span></article><article><strong>{mcq.accuracy}%</strong><span>MCQ accuracy</span></article></section>
