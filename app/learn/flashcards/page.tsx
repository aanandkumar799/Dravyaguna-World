...
export default function Flashcards() {
  ...
  const card=flashcardBank[i%flashcardBank.length]; const plant=plantCatalog.find(p=>p.id===card.plantId);
  ...
  return <main className="shell page"><Link href="/learn">← Learn</Link><header className="page-heading"><span className="eyebrow">RAPID REVISION · REVIEW</span><h1>Flashcards</h1><p>{stats.attempts} cards reviewed</p></header>
