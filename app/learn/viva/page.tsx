...
export default function Viva() {
  ...
  const q=vivaBank[i%vivaBank.length]; const p=plantCatalog.find(x=>x.id===q.plantId);
  ...
  return <main className="shell page"><Link href="/learn">← Learn</Link><header className="page-heading"><span className="eyebrow">ORAL PRACTICE · REVIEW</span><h1>Viva Mode</h1><p>{stats.attempts} prompts practiced</p></header>
